...
export const exchangePublicToken = async ({ publicToken, user }: exchangePublicTokenProps) => {
    try {
        ...
        // Get account infor from Plaid using the access token
        ...
        // Comment out Dwolla processor token creation later
        ...
        if (!fundingSourceUrl) {
            throw new Error('An error occured while creating the funding source URL')
        }
